...
<html>
   ...
   <% fname= (ArrayList<String>) request.getAttribute("list2"); %>
   <% lname= (ArrayList<String>) request.getAttribute("list3"); %>
   <% age= (ArrayList<Integer>) request.getAttribute("list4"); %>
   <% num= (ArrayList<Long>) request.getAttribute("list5"); %> 
   <head></head>
   <style>
...
<tr>
    ...
    <td><%out.println((String)lname.get(i)); %></td>
    <td><%out.println((Integer)age.get(i)); %></td>
    <td><%out.println((Long)num.get(i)); %></td>
